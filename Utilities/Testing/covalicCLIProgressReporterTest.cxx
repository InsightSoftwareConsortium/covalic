...
#include <cstdlib>
#include <covalicCLIProgressReporter.h>
...
int covalicCLIProgressReporterTest(int argc, char *itkNotUsed(argv)[] ) 
{
  if( argc != 1 )
    {
  ...
  std::string processName("covalicCLIProgressReporterTest");

  covalic::CLIProgressReporter reporter( processName.c_str(),
                                      &CLPProcessInfo,
                                      true );
  reporter.Start( );
  reporter.Report( 0.0 );
