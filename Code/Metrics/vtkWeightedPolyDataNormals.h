/*=========================================================================
  ...
  Module:    $RCSfile: vtkWeightedPolyDataNormals.h,v $
...
=========================================================================*/
// .NAME vtkWeightedPolyDataNormals - compute normals for polygonal mesh
// .SECTION Description
// vtkWeightedPolyDataNormals is a filter that computes point normals for a polygonal 
...
// NOTE
// Modified to return normals weighted by area

#ifndef __vtkWeightedPolyDataNormals_h
#define __vtkWeightedPolyDataNormals_h
...
class VTK_GRAPHICS_EXPORT vtkWeightedPolyDataNormals : public vtkPolyDataAlgorithm
{
public:
  vtkTypeRevisionMacro(vtkWeightedPolyDataNormals,vtkPolyDataAlgorithm);
  ...
  static vtkWeightedPolyDataNormals *New();
...
private:
  vtkWeightedPolyDataNormals(const vtkWeightedPolyDataNormals&);  // Not implemented.
  void operator=(const vtkWeightedPolyDataNormals&);  // Not implemented.
};
