/*=========================================================================
  ...
  Module:    $RCSfile: vtkWeightedPolyDataNormals.cxx,v $
...
vtkCxxRevisionMacro(vtkWeightedPolyDataNormals, "$Revision: 1.68.24.1 $");
vtkStandardNewMacro(vtkWeightedPolyDataNormals);
...
vtkWeightedPolyDataNormals::vtkWeightedPolyDataNormals()
{
...
int vtkWeightedPolyDataNormals::RequestData(
...
//PP
          ...
          n[j] = vertNormal[j] + polyNormal[j] / npts;
          }
...
//PP
          ...
          n[j] = vertNormal[j] * flipDirection;
          }
        }
      newNormals->SetTuple(i,n);
      }
...
//
void vtkWeightedPolyDataNormals::TraverseAndOrder (void)
{
  vtkIdType p1, p2, i, k;
  int j, l;
...
//
void vtkWeightedPolyDataNormals::MarkAndSplit (vtkIdType ptId)
{
  int i,j;
...
void vtkWeightedPolyDataNormals::PrintSelf(ostream& os, vtkIndent indent)
{
